pipeline {
  ...
  environment {
    ...
    EXT_REPO = 'Kometa'
    BUILD_VERSION_ARG = 'KOMETA_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-kometa'
    CONTAINER_NAME = 'kometa'
    DOCKERHUB_IMAGE = 'linuxserver/kometa'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/kometa'
    PR_DOCKERHUB_IMAGE = 'lspipepr/kometa'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-kometa/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-kometa\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-kometa\" \
          ...
          --label \"org.opencontainers.image.description=[Kometa](https://github.com/Kometa-Team/Kometa) is a powerful tool designed to give you complete control over your media libraries. With Kometa, you can take your customization to the next level, with granular control over metadata, collections, overlays, and much more.\" \
